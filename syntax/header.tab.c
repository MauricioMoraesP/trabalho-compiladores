...
{
       0,    66,    66,    77,    87,   117,   122,   126,   133,   137,
     137,   151,   155,   161,   168,   179,   178,   196,   200,   232,
     233,   237,   246,   257,   260,   263,   266,   272,   275,   281,
     284,   287,   290,   304,   309,   313,   321,   322,   326,   327,
     331,   332,   333,   337,   338,   339,   340,   341,   345,   346,
     347,   351,   352,   353,   357,   358,   359,   364,   372,   378,
     381,   384,   387,   391,   396
};
#endif
...
#line 66 "syntax/header.y"
        ...
        helper_change_parent(program, (yyvsp[-1].n));
        if ((yyvsp[0].n))
...
#line 77 "syntax/header.y"
        ...
        insert_variable(current, (yyvsp[-3].str), (yyvsp[-4].type), local_escope_index);
        helper_change_parent(decl, (yyvsp[-2].n));
...
#line 87 "syntax/header.y"
        ...
        helper_change_parent(func, (yyvsp[-1].n));
        Node *list = (yyvsp[0].n) ? (yyvsp[0].n) : create_nnary_node(NOLISTA_DECL, yylineno, TYVOID);
        nnary_add_child(list, func);
        (yyval.n) = list;
    }
#line 1293 "syntax/header.tab.c"
    break;

  case 5: /* DeclFuncVar: %empty  */
#line 117 "syntax/header.y"
                     { (yyval.n) = NULL; }
#line 1299 "syntax/header.tab.c"
    break;

  case 6: /* DeclProg: TPROGRAM Bloco  */
#line 122 "syntax/header.y"
                   { (yyval.n) = (yyvsp[0].n); }
#line 1305 "syntax/header.tab.c"
    break;

  case 7: /* DeclVar: TCOMMA TID_TOKEN DeclVar  */
#line 126 "syntax/header.y"
                             {
        ...
        helper_change_parent(list, (yyvsp[0].n));
        (yyval.n) = list;
    }
#line 1317 "syntax/header.tab.c"
    break;

  case 8: /* DeclVar: %empty  */
#line 133 "syntax/header.y"
                    { (yyval.n) = NULL; }
#line 1323 "syntax/header.tab.c"
    break;

  case 9: /* $@1: %empty  */
#line 137 "syntax/header.y"
            { create_new_scope(&current); local_escope_index = 0; }
...
#line 161 "syntax/header.y"
         ...
         if (current)  insert_parameter(current, (yyvsp[0].str),((yyvsp[-1].type) == TYINT ? INT_TYPE : CAR_TYPE), local_escope_index++);
         (yyval.n) = list;
     }
#line 1371 "syntax/header.tab.c"
    break;

  case 14: /* ListaParametrosCont: Tipo TID_TOKEN TCOMMA ListaParametrosCont  */
#line 168 "syntax/header.y"
                                                {
         Node *list = (yyvsp[0].n);
         Node *param = create_leaf_node(NOIDENTIFICADOR, yylineno, (yyvsp[-3].type), (yyvsp[-2].str), 0, 0);
         nnary_add_child(list, param);
         if (current) insert_parameter(current, (yyvsp[-2].str),((yyvsp[-3].type) == TYINT ? INT_TYPE : CAR_TYPE),local_escope_index++);
         (yyval.n) = list;
     }
#line 1383 "syntax/header.tab.c"
    break;

  case 15: /* $@2: %empty  */
#line 179 "syntax/header.y"
    {
        create_new_scope(&current);
        local_escope_index = 0;
    }
#line 1392 "syntax/header.tab.c"
    break;
...
#line 186 "syntax/header.y"
    {
        ...
        helper_change_parent(bloco, (yyvsp[-2].n));
        helper_change_parent(bloco, (yyvsp[-1].n));
        (yyval.n) = bloco;
    }
#line 1404 "syntax/header.tab.c"
    break;

  case 17: /* ListaDeclVar: %empty  */
#line 196 "syntax/header.y"
                  {
        (yyval.n) = create_nnary_node(NOLISTA_DECL, yylineno, TYVOID);
    }
#line 1412 "syntax/header.tab.c"
    break;

  case 18: /* ListaDeclVar: Tipo TID_TOKEN DeclVar TSEMICOLON ListaDeclVar  */
#line 201 "syntax/header.y"
    {
        Node *decl = create_nnary_node(NODECL_VAR, yylineno, (yyvsp[-4].type));
        Node *id = create_leaf_node(NOIDENTIFICADOR, yylineno, (yyvsp[-4].type), (yyvsp[-3].str), 0, 0);
        nnary_add_child(decl, id);
        if (current) insert_variable(current,(yyvsp[-3].str), ((yyvsp[-4].type) == TYINT ? INT_TYPE : CAR_TYPE),local_escope_index++);
...
#line 1445 "syntax/header.tab.c"
  ...
  case 19: /* Tipo: TINT  */
#line 232 "syntax/header.y"
         { (yyval.type) = TYINT; }
#line 1451 "syntax/header.tab.c"
    break;

  case 20: /* Tipo: TCAR  */
#line 233 "syntax/header.y"
           { (yyval.type) = TYCAR; }
#line 1457 "syntax/header.tab.c"
    break;
...
#line 237 "syntax/header.y"
        ...
        if ((yyvsp[0].n) == NULL) { (yyval.n) = (yyvsp[-1].n); } 
            ...
            nnary_add_child(list, (yyvsp[0].n)); 
            (yyval.n) = list; 
        }
    }
#line 1471 "syntax/header.tab.c"
    break;

  case 22: /* ListaComando: Comando  */
#line 246 "syntax/header.y"
              {
        if ((yyvsp[0].n) != NULL) { 
            Node *list = create_nnary_node(NOLISTA_COMANDOS, yylineno, TYVOID); 
            nnary_add_child(list, (yyvsp[0].n)); 
...
#line 1484 "syntax/header.tab.c"
    break;

  case 23: /* Comando: TSEMICOLON  */
#line 258 "syntax/header.y"
        { (yyval.n) = NULL; }
#line 1490 "syntax/header.tab.c"
    break;

  case 24: /* Comando: Expr TSEMICOLON  */
#line 261 "syntax/header.y"
        { (yyval.n) = (yyvsp[-1].n); }
#line 1496 "syntax/header.tab.c"
    break;

  case 25: /* Comando: TRETURN Expr TSEMICOLON  */
#line 264 "syntax/header.y"
        { (yyval.n) = create_unary_node(NORETURN, yylineno, TYVOID, (yyvsp[-1].n)); }
#line 1502 "syntax/header.tab.c"
    break;

  case 26: /* Comando: TREAD TID_TOKEN TSEMICOLON  */
#line 267 "syntax/header.y"
        {
...
#line 1560 "syntax/header.tab.c"
    break;

  case 33: /* Comando: Bloco  */
#line 305 "syntax/header.y"
        { (yyval.n) = (yyvsp[0].n); }
#line 1566 "syntax/header.tab.c"
    break;

  case 34: /* Expr: OrExpr  */
#line 310 "syntax/header.y"
        {
            (yyval.n) = (yyvsp[0].n);
        }
#line 1574 "syntax/header.tab.c"
    break;
...
#line 1588 "syntax/header.tab.c"
    break;

  case 37: /* OrExpr: AndExpr  */
#line 322 "syntax/header.y"
              { (yyval.n) = (yyvsp[0].n); }
#line 1594 "syntax/header.tab.c"
    break;

  case 38: /* AndExpr: AndExpr TAND EqExpr  */
#line 326 "syntax/header.y"
                        { (yyval.n) = create_binary_node(NOAND, yylineno, TYINT, (yyvsp[-2].n), (yyvsp[0].n)); }
#line 1600 "syntax/header.tab.c"
    break;

  case 39: /* AndExpr: EqExpr  */
#line 327 "syntax/header.y"
             { (yyval.n) = (yyvsp[0].n); }
...
#line 364 "syntax/header.y"
    ...
    helper_change_parent(call, (yyvsp[-1].n));
    (yyval.n) = call;
}
#line 1720 "syntax/header.tab.c"
    break;

  case 58: /* PrimExpr: TID_TOKEN TLPAREN TRPAREN  */
#line 372 "syntax/header.y"
                                {
        Node *call = create_nnary_node(NOCHAMADA_FUNCAO, yylineno, TYVOID);
...
#line 1780 "syntax/header.tab.c"
    break;


#line 1784 "syntax/header.tab.c"
